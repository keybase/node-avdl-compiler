...
(function() {
  ...
  exports.BaseEmitter = BaseEmitter = (function() {
    ...
    BaseEmitter.prototype.output = function(l, _arg) {
      var frag;
    ...
    BaseEmitter.prototype.emit_preface = function(infiles, types_only) {
    ...
    BaseEmitter.prototype.emit_imports = function(json, outfile, types_only) {
