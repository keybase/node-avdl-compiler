...
(function() {
  ...
  exports.GoEmitter = GoEmitter = (function() {
    ...
    GoEmitter.prototype.emit_preface = function(_arg) {
      var infile, types_only;
      infile = _arg.infile, types_only = _arg.types_only;
      this.output("// Auto-generated " + (types_only ? 'types' : 'types and interfaces') + " using " + pkg.name + " v" + pkg.version + " (" + pkg.homepage + ")");
