...
(function() {
  ...
  exports.GoEmitter = GoEmitter = (function() {
    ...
    GoEmitter.prototype.emit_variant_tag_getter = function(_arg) {
      var fname, go_field_suffix, obj, optional, ret_type, type, _ref;
      obj = _arg.obj, go_field_suffix = _arg.go_field_suffix;
      ...
      ret_type = this.go_lint_capitalize(obj["switch"].type);
      this.output("func (o *" + (this.go_export_case(obj.name)) + ") " + fname + "() " + ret_type + " {");
      this.tab();
      this.output("return o." + (this.variant_field(obj["switch"].name)));
      this.untab();
      return this.output("}");
    };
    ...
    GoEmitter.prototype.emit_variant_case_getter = function(_arg) {
      var c, cases, def, fname, go_field_suffix, obj, optional, ret_type, tag_val, type, v, _ref;
      obj = _arg.obj, c = _arg.c, go_field_suffix = _arg.go_field_suffix, cases = _arg.cases, def = _arg.def;
      _ref = this.emit_field_type(c.body.type, {
        pointed: false
      }), type = _ref.type, optional = _ref.optional;
      ret_type = type;
      fname = this.go_translate_identifier({
      ...
      this.untab();
      this.output("}");
      this.output("return *o." + (this.variant_field(c.body.name)));
      this.untab();
      this.output("}");
      return tag_val;
    };
    ...
    GoEmitter.prototype.emit_variant_case_constructor = function(_arg) {
      var c, case_type, fname, go_field_suffix, klass, obj, optional, tag_val, type, _ref;
      ...
      if (!c.label.def) {
        ...
        this.output("func New" + klass + "With" + fname + "(v " + case_type + ") " + klass + " {");
      } else if (!c.body["void"]) {
        this.output("func New" + klass + "Default(" + obj["switch"].name + " " + obj["switch"].type + ", v " + case_type + ") " + klass + " {");
        tag_val = obj["switch"].name;
      } else if (c.body["void"]) {
        this.output("func New" + klass + "Default(tag " + obj["switch"].type + ") " + klass + " {");
        tag_val = obj["switch"].name;
      }
      this.tab();
      ...
      if (!c.body["void"]) {
        this.output("" + (this.variant_field(c.body.name)) + " : &v,");
      }
      this.untab();
      this.output("}");
      this.untab();
    ...
    GoEmitter.prototype.emit_variant_object = function(_arg) {
      var body, go_field_suffix, obj, _i, _len, _ref;
      obj = _arg.obj, go_field_suffix = _arg.go_field_suffix;
      this.output("type " + (this.go_export_case(obj.name)) + " struct {");
      this.tab();
      go_field_suffix = this.variant_suffix();
    ...
    GoEmitter.prototype.emit_enum = function(t) {
      var i, name, s, _i, _j, _len, _len1, _ref, _ref1;
      name = t.name;
