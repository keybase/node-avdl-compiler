...
(function() {
  ...
  is_one_way = function(d) {
    return (d.notify != null) || (d.oneway != null);
  };
  ...
  exports.GoEmitter = GoEmitter = (function() {
    ...
    GoEmitter.prototype.emit_server_hook_method_type = function(_arg) {
      var details, name;
      name = _arg.name, details = _arg.details;
      return this.output("MethodTypes: []rpc.MethodType{" + (is_one_way(details) ? 'rpc.MethodNotify' : 'rpc.MethodCall, rpc.MethodCallCompressed') + "},");
    };
    ...
    GoEmitter.prototype.emit_message_client = function(_arg) {
      var arg, async, ctype, ctype_in, details, n, name, oarg, out_list, outs, ow, p, params, parg, protocol, res, res_in;
      ...
      this.output("err = c.Cli." + (ow ? "Notify" : "CallCompressed") + "(ctx, \"" + this._pkg + "." + protocol + "." + name + "\", " + oarg + res + ctype + ")");
      this.output("return");
      this.untab();
      return this.output("}");
    };
