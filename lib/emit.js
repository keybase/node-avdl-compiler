...
(function() {
  var GoEmitter, a_json_parse, fs, iced, log, make_esc, minimist, path, __iced_k, __iced_k_noop;
  ...
  GoEmitter = (function() {
    ...
    GoEmitter.prototype.run = function(files, cb) {
      var esc, f, src, ___iced_passed_deferral, __iced_deferrals, __iced_k;
            ...
            if (!(_i < _len)) {
              ...
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  ...
                  filename: "/Users/max/src/keybase/node-avdl-compiler/src/emit.iced",
                  funcname: "GoEmitter.run"
                });
                _this.run_file(f, esc(__iced_deferrals.defer({
                  lineno: 152
                })));
    ...
    GoEmitter.prototype.emit_imports = function(_arg) {
      var import_as, imports, line, _i, _len, _ref;
    ...
    GoEmitter.prototype.emit_server_hook_method_type = function(name, details) {
      return this.output("MethodType: rpc.Method" + (details.notify != null ? 'Notify' : 'Call') + ",");
    };
    ...
    GoEmitter.prototype.emit_message_client = function(protocol, name, details, async) {
      var arg, n, oarg, out_list, outs, p, params, parg, res, res_in;
      p = this.go_export_case(protocol);
      arg = details.request;
      res = details.response;
      out_list = [];
      ...
      oarg += "}";
      res = details.notify != null ? "" : ", " + res_in;
      this.output("err = c.Cli." + (details.notify != null ? "Notify" : "Call") + "(ctx, \"" + this._pkg + "." + protocol + "." + name + "\", " + oarg + res + ")");
      this.output("return");
      this.untab();
      return this.output("}");
    };
