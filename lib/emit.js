...
(function() {
  ...
  exports.GoEmitter = GoEmitter = (function() {
    ...
    GoEmitter.prototype.emit_field_type = function(t, _arg) {
      var key, optional, pointed, type;
      pointed = (_arg != null ? _arg : {}).pointed;
      optional = !!pointed;
      type = typeof t === 'string' ? this.go_primitive_type(t) : typeof t === 'object' ? Array.isArray(t) && (t[0] == null) ? (optional = true, "*" + this.go_primitive_type(t[1])) : t.type === "array" ? "[]" + this.go_primitive_type(t.items) : t.type === "map" ? (key = t.keys != null ? this.go_lint_capitalize(this.emit_field_type(t.keys).type) : "string", ("map[" + key + "]") + this.go_lint_capitalize(this.emit_field_type(t.values).type)) : "ERROR" : "ERROR";
      if (pointed) {
        type = "*" + type;
      }
      return {
