...
(function() {
  ...
  exports.GoEmitter = GoEmitter = (function() {
    ...
    GoEmitter.prototype.go_unsnake = function(n) {
      var part, parts, recase;
      parts = n.split(/_+/);
      recase = function(n) {
    ...
    GoEmitter.prototype.case_label_to_go = function(_arg) {
      var label, prefixed;
      label = _arg.label, prefixed = _arg.prefixed;
      if (label == null) {
        return "Default";
        ...
        return this.go_unsnake(label.toString());
      }
    };
