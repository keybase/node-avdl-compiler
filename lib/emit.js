...
(function() {
  ...
  exports.GoEmitter = GoEmitter = (function() {
    ...
    GoEmitter.prototype.emit_record = function(_arg) {
      var f, go_field_suffix, obj, omitempty, optional, type, _i, _len, _ref, _ref1;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        this.output([
          this.go_export_case(f.name, {
            go_field_suffix: go_field_suffix
          }), this.go_lint_capitalize(type), "`codec:\"" + f.name + omitempty + "\" json:\"" + f.name + omitempty + "\"`"
        ].join("\t"));
      }
      this.untab();
      return this.output("}");
    ...
    GoEmitter.prototype.emit_enum = function(t) {
      var i, s, _i, _j, _len, _len1, _ref, _ref1;
      ...
      this.untab();
      this.output(")");
      this.output("var " + t.name + "Map = map[string]" + t.name + "{");
      this.tab();
      _ref1 = t.symbols;
