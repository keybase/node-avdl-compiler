...
(function() {
  var GoEmitter, fs, is_one_way, make_esc, minimist, path, pkg,
    __slice = [].slice;
  ...
  exports.GoEmitter = GoEmitter = (function() {
    ...
    GoEmitter.prototype.emit_imports = function(_arg) {
      var import_as, imports, line, messages, types, _i, _len, _ref;
    ...
    GoEmitter.prototype.emit_preface = function(_arg) {
      ...
      this.output("//   Input file: " + (path.relative(process.cwd(), infile)));
      return this.output("");
    };
