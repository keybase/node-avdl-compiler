...
(function() {
  ...
  exports.GoEmitter = GoEmitter = (function() {
    ...
    GoEmitter.prototype.emit_field_type = function(t, _arg) {
      ...
      optional = !!pointed;
      type = typeof t === 'string' ? this.go_primitive_type(t) : typeof t === 'object' ? Array.isArray(t) && (t[0] == null) ? (optional = true, "*" + this.go_primitive_type(t[1])) : t.type === "array" ? "[]" + this.go_primitive_type(t.items) : t.type === "map" ? (key = t.keys != null ? this.go_primitive_type(t.keys) : "string", ("map[" + key + "]") + this.go_primitive_type(t.values)) : "ERROR" : "ERROR";
      if (pointed) {
        type = "*" + type;
      }
      return {
