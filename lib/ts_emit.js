...
(function() {
  ...
  exports.TypescriptEmitter = TypescriptEmitter = (function(_super) {
    ...
    TypescriptEmitter.prototype.make_map_type = function(_arg) {
      var key_type, t;
      t = _arg.t;
      key_type = t.keys != null ? this.emit_field_type(t.keys).type : "string";
      return "{[key: " + key_type + "]: " + (this.emit_field_type(t.values).type) + "}";
    };
    ...
    TypescriptEmitter.prototype.emit_enum = function(t) {
      var e_name, e_num, s, _i, _j, _len, _ref, _ref1;
      this.output("export enum " + t.name + " {");
      this.tab();
      _ref = t.symbols;
    ...
    TypescriptEmitter.prototype.emit_variant = function(t) {
      ...
      this.output("export type " + t.name + " = " + (cases.join(" | ")));
      return this.output("");
    };
