...
(function() {
  ...
  exports.TypescriptEmitter = TypescriptEmitter = (function(_super) {
    ...
    TypescriptEmitter.prototype.emit_preface = function(infiles, _arg) {
      ...
      this.output(" *");
      this.output(" * Code generated to TypeScript types by " + pkg.name + " v" + pkg.version + " (" + pkg.homepage + "). DO NOT EDIT.");
    ...
    TypescriptEmitter.prototype.emit_field = function(_arg) {
      var fieldName, jsonkey, name, null_serializable, optional, optionalkey, type, _ref1;
      name = _arg.name, type = _arg.type, jsonkey = _arg.jsonkey, optionalkey = _arg.optionalkey, null_serializable = _arg.null_serializable;
      _ref1 = this.emit_field_type(type, {
        optionalkey: optionalkey
      }), type = _ref1.type, optional = _ref1.optional;
      fieldName = camelCase(jsonkey || name);
      return this.output("" + fieldName + (optional ? '?' : '') + ": " + type + (null_serializable ? ' | null' : ''));
    };
