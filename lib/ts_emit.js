...
(function() {
  var TypescriptEmitter, path_lib, pkg, _,
    __slice = [].slice;
  ...
  exports.TypescriptEmitter = TypescriptEmitter = (function() {
    ...
    TypescriptEmitter.prototype.emit_preface = function(infiles) {
      var infile, _i, _len;
      this.output("/*");
    ...
    TypescriptEmitter.prototype.emit_variant = function(t) {
      var cases;
      cases = t.cases.map(function(c) {
        ...
        bodyType = (function() {
          switch (false) {
            case c.body !== null:
              return 'null';
            case typeof c.body !== 'string':
              return c.body;
            case c.body.type !== 'array':
              return c.body.items + '[]';
            default:
              return '';
          }
        })();
        bodyStr = c.body ? ", " + c.label.name + ": " + bodyType + " | null" : '';
        return "{ " + t["switch"].name + ": " + t["switch"].type + "." + c.label.name + bodyStr + " }";
      });
      return this.output("export type " + t.name + " = " + (cases.join(" | ")));
    };

    TypescriptEmitter.prototype.emit_fixed = function(t) {
      return this.output("export export type " + t.name + " = string | null");
    };

    TypescriptEmitter.prototype.emit_enum = function(_arg) {
      var e_name, e_num, name, nostring, s, t, _i, _j, _len, _ref, _ref1;
      t = _arg.t, nostring = _arg.nostring;
      name = t.name;
      this.output("export enum " + name + " {");
      this.tab();
      _ref = t.symbols;
    ...
    TypescriptEmitter.prototype.emit_typedef = function(t) {
      this.output("export type " + t.name + " = " + (this.emit_field_type(t.typedef).type));
      return true;
    };
    ...
    TypescriptEmitter.prototype.emit_record = function(obj) {
      var f, _i, _len, _ref;
      this.output("export type " + obj.name + " = {");
      this.tab();
      _ref = obj.fields;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        f = _ref[_i];
