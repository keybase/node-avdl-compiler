...
(function() {
  ...
  exports.TypescriptEmitter = TypescriptEmitter = (function(_super) {
    ...
    TypescriptEmitter.prototype.emit_field_type = function(t, _arg) {
      ...
      type = typeof t === 'string' ? this.convert_primitive_type(t) : typeof t === 'object' ? Array.isArray(t) ? t[0] == null ? (optional = true, this.emit_field_type(t[1]).type + " | null") : "ERROR" : t.type === "array" ? this.emit_field_type(t.items).type + "[]" : t.type === "map" ? this.make_map_type(t) : "ERROR" : "ERROR";
      return {
        type: type,
        optional: optional
      };
    ...
    TypescriptEmitter.prototype.emit_field = function(_arg) {
      var name, optional, optionalkey, type, _ref;
      name = _arg.name, type = _arg.type, optionalkey = _arg.optionalkey;
