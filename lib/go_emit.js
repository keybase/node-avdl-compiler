...
(function() {
  ...
  exports.GoEmitter = GoEmitter = (function(_super) {
    ...
    GoEmitter.prototype.emit_server_hook_timeout = function(_arg) {
      var details, name, timeout_msec;
      name = _arg.name, details = _arg.details;
      timeout_msec = details.timeout_msec || 0;
      return this.output("Timeout: func() time.Duration { return " + timeout_msec + " * time.Millisecond },");
    };
