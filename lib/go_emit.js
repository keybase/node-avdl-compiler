...
(function() {
  var GoEmitter, fs, is_one_way, make_esc, minimist, path_lib, pkg,
    __slice = [].slice;
  ...
  exports.GoEmitter = GoEmitter = (function() {
    ...
    GoEmitter.prototype.emit_field = function(_arg) {
      var cols, exported, go_field_suffix, jsonkey, mpackkey, name, optional, pointed, type, _ref;
      name = _arg.name, type = _arg.type, go_field_suffix = _arg.go_field_suffix, exported = _arg.exported, pointed = _arg.pointed, jsonkey = _arg.jsonkey, mpackkey = _arg.mpackkey;
    ...
    GoEmitter.prototype.emit_record = function(_arg) {
      var go_field_suffix, no_deep_copy, obj;
      obj = _arg.obj, go_field_suffix = _arg.go_field_suffix, no_deep_copy = _arg.no_deep_copy;
    ...
    GoEmitter.prototype.emit_message_client = function(_arg) {
      var arg, async, call_method, ctype, ctype_in, details, n, name, oarg, out_list, outs, ow, p, params, parg, protocol, res, res_in;
      ...
      this.output("err = c.Cli." + (ow ? "Notify" : call_method) + "(ctx, \"" + this._pkg + "." + protocol + "." + name + "\", " + oarg + res + ctype + ")");
      this.output("return");
      this.untab();
      return this.output("}");
    };
    ...
    GoEmitter.prototype.emit_preface = function(_arg) {
      var infile, _i, _len;
      infile = _arg.infile;
      this.output("// Auto-generated to Go by " + pkg.name + " v" + pkg.version + " (" + pkg.homepage + ")");
      if (infiles.length === 1) {
        this.output("//   Input file: " + (path_lib.relative(process.cwd(), infile[0])));
      } else {
    ...
    GoEmitter.prototype.run = function(_arg) {
      var infiles, json, types_only;
      infiles = _arg.infiles, json = _arg.json, types_only = _arg.types_only;
      this.emit_preface({
        infiles: infiles
      });
