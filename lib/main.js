...
(function() {
  var GoEmitter, Main, TypescriptEmitter, avdl2json, emit, fs, iced, make_esc, minimist, output, pathmod, usage, __iced_k, __iced_k_noop;
  ...
  emit = function(_arg, cb) {
    var code, emitter, infile, json, lang, outfile, types_only;
    infile = _arg.infile, outfile = _arg.outfile, json = _arg.json, lang = _arg.lang, types_only = _arg.types_only;
          ...
          (function(__iced_k) {
            if (_this.batch) {
              ...
              (function(__iced_k) {
                ...
                }, console.log(__iced_deferrals.defer({
                  lineno: 147
                })));
                __iced_deferrals._fulfill();
              })(__iced_k);
