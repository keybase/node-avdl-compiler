...
(function() {
  ...
  exports.Main = Main = (function() {
    ...
    Main.prototype.do_file = function(_arg, cb) {
      var ast, code, esc, infile, outfile, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      infile = _arg.infile, outfile = _arg.outfile;
        ...
        return (function(__iced_k) {
          if (_this.clean) {
            (function(__iced_k) {
              ...
              fs.unlink(outfile, esc(__iced_deferrals.defer({
                lineno: 83
              })));
              __iced_deferrals._fulfill();
            })(function() {
              return __iced_k(console.log("Deleting " + outfile));
            });
          } else {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
