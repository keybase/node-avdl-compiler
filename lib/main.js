...
(function() {
  var GoEmitter, Main, PythonEmitter, TypescriptEmitter, avdl2json, emit, fs, iced, make_esc, merge_asts, minimist, output, pathmod, usage, _, __iced_k, __iced_k_noop;
  ...
  merge_asts = function(ast1, ast2) {
    return _.mergeWith(ast1, ast2, function(value1, value2) {
