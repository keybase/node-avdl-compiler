...
//   Input file: /Users/joshblum/go/src/github.com/keybase/node-avdl-compiler/test/files/../avdl/sample.avdl
...
func (c SampleClient) ProcessBigBytes(ctx context.Context, bytes BigBytes) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "sample.1.sample.processBigBytes", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
